...
type RpcReplyWithTablePointer struct {
...
type RpcReplyWithCliPointer struct {
	XMLName          xml.Name `xml:"rpc-reply"`
	Text             string   `xml:",chardata"`
	Junos            string   `xml:"junos,attr"`
	Cli *Cli `xml:"cli"`
...
func main() {
	var r1 RpcReply
	var r2 RpcReplyWithCliPointer
	var r3 RpcReplyWithTablePointer
	fmt.Println("=====================================================================================")
	fmt.Printf("Total Memory Usage StructType: RpcReply Original%T => [%d]\n", r1, unsafe.Sizeof(r1))
	fmt.Println("=====================================================================================")
	fmt.Printf("Total Memory Usage StructType: RpcReplyWithCliPointer %T => [%d]\n", r2, unsafe.Sizeof(r2))
	fmt.Println("=====================================================================================")
	fmt.Printf("Total Memory Usage StructType: RpcReplyWithTablePointer %T => [%d]\n", r3, unsafe.Sizeof(r3)) 
	fmt.Println("=====================================================================================")
}
